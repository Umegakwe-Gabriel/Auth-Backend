...
const createTask = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const tasked = yield timeLineModel_1.default.create({ task, priority });
...
const getTask = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const tasked = yield timeLineModel_1.default.find().sort({ createdAt: -1 });
        return res.status(201).json({ message: "Task has been created", data: tasked });
    }
    catch (error) {
        return res.status(404).json({
...
const getOneTask = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { id } = req.params;
        const tasked = yield timeLineModel_1.default.findById(id);
        return res.status(201).json({ message: "Task has been created", data: tasked });
    }
    catch (error) {
        return res.status(404).json({
