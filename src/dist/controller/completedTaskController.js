...
const completeTaskModel_1 = __importDefault(require("../model/completeTaskModel"));
const createTask = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { task, priority, isComplete } = req.body;
        const tasked = yield completeTaskModel_1.default.create({ task, priority, isComplete });
...
const getTask = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        // const {task, priority, isComplete} = req.body;
        const tasked = yield completeTaskModel_1.default.find().sort({ createdAt: -1 });
        return res.status(201).json({ message: "Task has been created", data: tasked });
    }
    catch (error) {
        return res.status(404).json({
...
const getOneTask = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { id } = req.params;
        const tasked = yield completeTaskModel_1.default.findById(id);
        return res.status(201).json({ message: "Task has been created", data: tasked });
    }
    catch (error) {
        return res.status(404).json({
...
const UpdateOneTask = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { id } = req.params;
        const tasked = yield completeTaskModel_1.default.findByIdAndUpdate(id, {
            isComplete: true,
        }, { new: true });
...
const DeleteOneTask = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { id } = req.params;
        const tasked = yield completeTaskModel_1.default.findByIdAndDelete(id);
